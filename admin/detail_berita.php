...
$berita = mysqli_query($conn, "SELECT * FROM `berita` JOIN kategori ON berita.id_kategori=kategori.id_kategori WHERE id_berita = $id;");
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <a href="berita.php" class="btn btn-warning btn-sm mb-3">Kembali</a>
          </div>
          <div class="row">

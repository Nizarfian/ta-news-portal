...
<body class="animsition">
                    ...
                    <nav class="menu-desktop">
                        ...
                        <ul class="main-menu">
                            ...
                            <li class="mega-menu-item">
                                <a
                                    href="menu.php?idKategori=<?= $data['id_kategori']; ?>"><?= $data['nama_kategori']; ?></a>
                            </li>
                            <?php endforeach; ?>
                        </ul>
                    </nav>
            ...
            <div class="row justify-content-center">
              ...
              " method="post" id="komentar">
                                ...
                                <textarea class="bo-1-rad-3 bocl13 size-a-15 f1-s-13 cl5 plh6 p-rl-18 p-tb-14 m-b-20"
                                    id="isiKomentar" name="isiKomentar" required placeholder="Komentar..."></textarea>
                        ...
                        <!-- comment -->
                        <div id="komentar-section" class="bo-1-rad-1 bocl13 p-b-20" style="background-color: #dddddd;">
                ...
                ?>
                    ...
                    continue;
                                ...
                                <div class="col-12">
                                    ...
                                    <div>
                                        <span class="cl8">
                                            <a href="menu.php?idKategori=<?= $data['id_kategori']; ?>"
                                            ...
                                            <span
                                                class="f1-s-3"><?= date("d M Y", strtotime($data["tgl_rilis"])); ?></span>
                                        </span>
    ...
    <script>
    window.location.hash = '#komentar-section';

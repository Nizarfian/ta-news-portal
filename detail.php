  ...
  <div class="container">
    <div class="headline bg0 flex-wr-sb-c p-tb-8">
      <div class="f2-s-1 p-r-30 m-tb-6">
        ...
        <span class="breadcrumb-item f1-s-3 cl9"> Judul </span>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-10 col-lg-9 p-b-30">
          <div class="p-r-10 p-r-0-sr991">
            ...
            <div class="p-b-50">
              ...
              <form>
                <input class="bo-1-rad-3 bocl13 size-a-16 f1-s-13 cl5 plh6 p-rl-18 m-b-20" type="text" name="" placeholder="Nama" />

                <input class="bo-1-rad-3 bocl13 size-a-16 f1-s-13 cl5 plh6 p-rl-18 m-b-20" type="date" name="" />

                <textarea class="bo-1-rad-3 bocl13 size-a-15 f1-s-13 cl5 plh6 p-rl-18 p-tb-14 m-b-20" name="" placeholder="Komentar..."></textarea>

                <button class="size-a-17 bg2 borad-3 f1-s-11 cl0 hov-btn1 trans-03 p-rl-15 m-t-10">
                  Kirim Komentar
                </button>
              </form>
            </div>
